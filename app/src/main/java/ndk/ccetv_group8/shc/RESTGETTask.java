...
import static ndk.ccetv_group8.shc.NetworkUtils.performHTTPGET;
...
public class RESTGETTask extends AsyncTask<Void, Void, String[]> {
    ...
    RESTGETTask(String URL, Context context, View progressBar, View form, String TAG, Async_Response async_response) {
    ...
    RESTGETTask(String URL, Context context, View progressBar, View form, String TAG, Async_Response_JSON_object async_response_json_object) {
